...
fig.update_layout(
    ...
    # --- CORRECCIÓN: Usamos una URL consistente y ajustamos el tamaño ---
    images=[
        dict(
            source="https://www.maptek.com/wp-content/uploads/2023/10/Maptek-logo-standard-colour-1.png",
            xref="paper", yref="paper",
            x=0.02, y=0.1,
            sizex=0.15, sizey=0.15, # Tamaño ajustado
