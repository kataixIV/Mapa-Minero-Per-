...
# Versión 2.4 con Minerales Secundarios
# ==========================================================
...
def cargar_y_geocodificar_datos():
    ...
    # --- CAMBIO: Añadimos "Minerales secundarios" a la lista de columnas necesarias ---
...
def display_click_data(clickData):
    ...
    return [
        ...
        # --- NUEVO: Mostrar Minerales Secundarios en el panel de información ---
