...
# Versión 2.3 con corrección manual del usuario
# ==========================================================
...
def cargar_y_geocodificar_datos():
    ...
    # Se usa el nombre de columna original del Excel: "Tipo Cliente"
...
@app.callback(
    ...
    [Input('filtro-region', 'value'),
     ...
     # --- CORRECCIÓN 1: El Input ID debe coincidir con el Dropdown ---
...
def update_map(region_seleccionada, mineral_seleccionado, cliente_seleccionado, nombre_buscado):
    ...
    if cliente_seleccionado:
        # --- CORRECCIÓN 2: El nombre de la columna debe ser exacto (Mayúsculas) ---
...
def display_click_data(clickData):
    ...
    return [
        ...
        # --- CORRECCIÓN 3: El nombre de la columna debe ser exacto (Mayúsculas) ---
