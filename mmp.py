...
# Versión 2.1 con filtro de Tipo de Cliente
# ==========================================================
...
def cargar_y_geocodificar_datos():
    ...
    # --- CAMBIO: Añadimos "Tipo de cliente" a la lista de columnas necesarias ---
...
# --- NUEVO: Opciones para el filtro de Tipo de Cliente ---
opciones_tipo_cliente = [{'label': i, 'value': i} for i in sorted(df_minas['Tipo de cliente'].unique())]
...
app.layout = html.Div(style={'display': 'flex', 'height': '100vh', 'fontFamily': 'Arial'}, children=[
    ...
    html.Div(style={'flex': '1', 'display': 'flex', 'flexDirection': 'column', 'backgroundColor': '#f9f9f9'}, children=[
        ...
        html.Div(style={'display': 'flex', 'gap': '20px', 'padding': '20px', 'backgroundColor': 'white',
            ...
            # --- NUEVO: Dropdown para Tipo de Cliente ---
            dcc.Dropdown(
        ...
        html.Div(style={'flex': '1', 'position': 'relative'}, children=[
            dcc.Graph(id='mapa-minas', style={'height': '100%'})
        ])
    ]),
...
@app.callback(
    ...
    [Input('filtro-region', 'value'),
     ...
     # --- NUEVO: Input para el filtro de Tipo de Cliente ---
...
def update_map(region_seleccionada, mineral_seleccionado, cliente_seleccionado, nombre_buscado):
    ...
    # --- NUEVO: Lógica para filtrar por Tipo de Cliente ---
    if cliente_seleccionado:
        dff = dff[dff['Tipo de cliente'] == cliente_seleccionado]
    if nombre_buscado:
...
def display_click_data(clickData):
    ...
    return [
        ...
        # --- NUEVO: Mostrar Tipo de Cliente en el panel de información ---
        html.B("Tipo de Cliente: "), html.Span(mina_info['Tipo de cliente']), html.Br(), html.Br(),
